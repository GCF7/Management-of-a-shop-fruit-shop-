...
public class GUIActualizarPais extends JFrame {
	...
	private void initGUI() {
		...
		JPanel mainPanel = new JPanel(new BorderLayout(10, 10));
			...
			northPanel.add(new JLabel("Actualizar Pais"));
				...
				button.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (create) {
							...
							try {
							Controlador.getInstance().accion(Events.ACTUALIZAR_PAIS, 
									new TPais(Integer.parseInt(out[0]), out[1], true, 0));
							} 
							catch (Exception ex) {
