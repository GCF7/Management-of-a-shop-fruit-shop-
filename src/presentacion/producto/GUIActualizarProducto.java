...
public class GUIActualizarProducto extends JFrame {

	private String[] labels = { "Id", "IdMarca", "Nombre", "Precio", "Unidades" };
	...
	private void initGUI() {
		...
		JPanel mainPanel = new JPanel(new BorderLayout(10, 10));
			...
			northPanel.add(new JLabel("Actualizar Producto"));
				...
				button.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						...
						if (create) {
							...
							try {
							Controlador.getInstance().accion(Events.ACTUALIZAR_PRODUCTO, 
									new TProducto(Integer.parseInt(out[0]), Integer.parseInt(out[1]), out[2], Float.parseFloat(out[3]), Integer.parseInt(out[4]), true));
							} catch (Exception ex) {
